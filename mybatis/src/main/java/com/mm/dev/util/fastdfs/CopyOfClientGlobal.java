...
package com.mm.dev.util.fastdfs;
...
import com.mm.dev.util.fastdfs.common.IniFileReader;
import com.mm.dev.util.fastdfs.common.MyException;
...
*/
@ConfigurationProperties(locations = "fastdfs")
public class CopyOfClientGlobal
{
	public static int g_connect_timeout = 2; //millisecond
	public static int g_network_timeout = 30; //millisecond
	public static String g_charset = "utf-8";
	public static int g_tracker_http_port = 80;
	public static boolean g_anti_steal_token = false;  //if anti-steal token
	public static String g_secret_key = "FastDFS1234567890";   //generage token secret key
	public static TrackerGroup g_tracker_group;
	
	public static final int DEFAULT_CONNECT_TIMEOUT = 5;  //second
	public static final int DEFAULT_NETWORK_TIMEOUT = 30; //second
	
	private CopyOfClientGlobal()
	{
	}
...
*/
	public static Socket getSocket(String ip_addr, int port) throws IOException
	{
		...
		sock.setSoTimeout(CopyOfClientGlobal.g_network_timeout);
		sock.connect(new InetSocketAddress(ip_addr, port), CopyOfClientGlobal.g_connect_timeout);
		return sock;
	}
...
*/
	public static Socket getSocket(InetSocketAddress addr) throws IOException
	{
		Socket sock = new Socket();
		sock.setSoTimeout(CopyOfClientGlobal.g_network_timeout);
		sock.connect(addr, CopyOfClientGlobal.g_connect_timeout);
		return sock;
	}
	...
	{
		CopyOfClientGlobal.g_connect_timeout = connect_timeout;
	}
	...
	{
		CopyOfClientGlobal.g_network_timeout = network_timeout;
	}
	...
	{
		CopyOfClientGlobal.g_charset = charset;
	}
	...
	{
		CopyOfClientGlobal.g_tracker_http_port = tracker_http_port;
	}
	...
	{
		CopyOfClientGlobal.g_anti_steal_token = anti_steal_token;
	}
	...
	{
		CopyOfClientGlobal.g_secret_key = secret_key;
	}
	...
	{
		CopyOfClientGlobal.g_tracker_group = tracker_group;
	}
}
