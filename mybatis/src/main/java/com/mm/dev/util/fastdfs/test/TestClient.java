...
package com.mm.dev.util.fastdfs.test;

import java.io.File;
import java.net.InetSocketAddress;

import com.mm.dev.util.fastdfs.ClientGlobal;
import com.mm.dev.util.fastdfs.ProtoCommon;
import com.mm.dev.util.fastdfs.ServerInfo;
import com.mm.dev.util.fastdfs.StorageClient;
import com.mm.dev.util.fastdfs.StorageClient1;
import com.mm.dev.util.fastdfs.StorageServer;
import com.mm.dev.util.fastdfs.TrackerClient;
import com.mm.dev.util.fastdfs.TrackerServer;
import com.mm.dev.util.fastdfs.common.NameValuePair;
...
public class TestClient
{
  ...
  public static void main(String args[])
  {
	  ...
	  args = new String[2];
	  args[0] = TestClient.class.getResource("/").getPath() + "fdfs_client.conf";
	  args[1] = "C:\\Users\\Adminstrator\\Desktop\\gDirective.js";
  	if (args.length < 2)
  	{
  	...
  	try
  	{
  		...
  		*/
  		...
  		//results = client.upload_file(local_filename,null, null, meta_list);
  		if (results != null)
  		{
  			String file_id;
  			int ts;
